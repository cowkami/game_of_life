...
class Application(tk.Frame):
    ...
    def __init__(self, master=None, FONT=20, height=100, width=100):
        ...
        self.state = [[randint(0, 1) for w in range(self.WIDTH)] for h in range(self.HEIGHT)]
        self.next_state = [[0 for w in range(self.WIDTH)] for h in range(self.HEIGHT)]
